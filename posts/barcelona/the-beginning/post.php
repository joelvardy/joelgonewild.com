<?php
    ...
    $post->written = '4th May 2014';
    $post->heroPhoto = 'cacti-around-montjuic-castle';

?>

<p>It was an early start, leaving Sheffield at 3am to get to Liverpool with plenty of time to catch our flight.. But that didn't stop us almost missing it because we weren't paying attention to the time in the departure lounge.</p>
