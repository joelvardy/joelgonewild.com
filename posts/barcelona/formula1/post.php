<?php
    ...
    $post->title = 'Formula1';
    $post->written = '9th May 2014';
    $post->heroPhoto = 'lotus';

?>

<p>Soon after we set the dates for this trip, I found that there was an F1 race the weekend we were leaving. I decided that we should get tickets to the Friday practice sessions.</p>

<p>We had a few issues getting a train to the circuit, I insisted it was one train.. It wasn't :P</p>
