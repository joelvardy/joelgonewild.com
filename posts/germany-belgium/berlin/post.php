<?php
    ...
    $post->title = 'Berlin';
    $post->written = '18th August 2014';
    $post->heroPhoto = 'brandenburg-gate';

?>

<p>Just two days after landing at Luton after <a href="/category/morzine" title="Mountain biking in Morzine">my trip to The Alps</a>, I was back flying out from Luton en route to Berlin.</p>
