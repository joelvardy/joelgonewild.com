...
$post->title = 'My Birthday';
$post->written = '10th January 2016';
$post->heroPhoto = 'view-looking-south-east-from-st-peters-church';

?>

<p>I'd set my alarm just before sunrise, upon waking up I looked out of the window, which had largely frosted over on the outside, and saw that the cloud cover was so thick there was no point heading out for some golden sun.</p>

<p>It was my 23rd Birthday, and I'd brought a few cards from home, so I opened them and thanked people back home.</p>
